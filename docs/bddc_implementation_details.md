...
>
> **実測**: 1スレッド、単位立方体、order=1 での ICCG vs BDDC:
>
> | 問題 | DOFs | ICCG | BDDC | ICCG優位 |
> |------|------|------|------|---------|
> | H1 Poisson (maxh=0.07) | 3.3K | 0.004s (21反復) | 0.056s (2反復) | 13x |
> | HCurl curl-curl (maxh=0.07) | 20K | 0.075s (56反復) | 0.234s (2反復) | 3x |
>
> ICCGはセットアップが軽量 (~0ms) で反復数も十分少ないため、p=1では常に高速。
