...
3次元単位立方体上のPoisson方程式。BDDC (NGSolve組込み), IC, SGS の3手法を比較する。
...
| 問題の特徴 | 推奨手法 | 理由 |
|-----------|---------|------|
| HCurl 渦電流 (大規模) | **HYPRE AMS+BiCGStab** | 1.44M DOFsで26反復収束、GMRES比33x高速 |
| HCurl curl-curl (実数) | **Shifted-ICCG** or **HYPRE AMS** | auto_shift有効化 |
| H1 | **ICCG** | メモリ効率に優れ高速 |
| HCurl 渦電流 (小中規模) | **ICCG** or **COCR** | 複素対称行列対応 |
